...
The contents this version are organized into various folders, as follows:

* src: This folder contains Java files for the AMES V5.1 repository.
* psst: This folder contains Python files required for solving the AMES V5.1 SCUC and SCED optimizatons.
* nbproject: This folder, generated by NetBeans, contains files required for compilation of AMES V5.1. The contents of this folder are automatically called in the 'build.xml' file, which is required to compile AMES V5.1.
* lib: This folder contains all required Java library files for AMES V5.1.  
* fncsDependencies: This folder contains all required files to run AMES V5.1 with FNCS. 
* dist: This folder contains an executable JAR file for AMES V5.1. 
* data: This folder contains input data files for AMES V5.1.
* TESAgents: This folder contains: files for transactive agents; files required to establish communication with FNCS; and files required to compile and run AMES V5.1.
